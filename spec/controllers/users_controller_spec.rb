	...
	describe "GET 'index'" do
		...
		describe "for signed-in users" do
			...
			before(:each) do
				...
				Factory(:user, :email => "user2@example.net")
				Factory(:user, :email => "user3@example.net")
			...
			it "should have an element for each other" do
				get :index
  ...
  describe "GET 'new'" do
	...
	describe "GET 'edit'" do
		...
		it "should have a link to change the Gravatar" do
			get :edit, :id => @user
			response.should have_selector('a', :href => 'http://gravatar.com/emails', :content => 
"change")
		end
	end
	...
	describe "PUT 'update'" do
		...
		describe "success" do
			...
			before(:each) do
				@attr = { :name => "User Name", :email => "user@example.com", :password => "example", :password_confirmation => "example" }
			end
	...
	describe "DELETE 'destroy'" do
		...
		describe "for admin user" do
			...
			it "should redirect to the users page" do
				delete :destroy, :id => @user
  			flash[:success].should =~ /destoyed/i
